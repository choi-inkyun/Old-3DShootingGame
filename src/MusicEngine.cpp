/////////// 뮤직 라이브러리 ///////////////
// 사용법
// 상속을 시켜준후 Init 를 불러옴 각 int 형으로 변수를 만들어서
// 변수 = load 그리고 play(변수) 써주면 됨
////////////////////////////////////////////
...
extern MusicEngine MEng;
extern SoundEngine SoEng;
#define INITGUID
...
int SoundEngine::DSound_Load_WAV(char *filename)
{
...
int SoundEngine::DSound_Replicate_Sound(int source_id)
{
...
int SoundEngine::DSound_Init(void)
{
...
int SoundEngine::DSound_Shutdown(void)
{
...
int SoundEngine::DSound_Play(int id, int flags, int volume, int rate, int pan)
{
...
int SoundEngine::DSound_Set_Volume(int id,int vol)
{
...
int SoundEngine::DSound_Set_Pan(int id,int pan)
{
...
int SoundEngine::DSound_Stop_Sound(int id)
{
...
int SoundEngine::DSound_Delete_All_Sounds(void)
{
...
int SoundEngine::DSound_Delete_Sound(int id)
{
...
int SoundEngine::DSound_Stop_All_Sounds(void)
{
...
int SoundEngine::DSound_Status_Sound(int id)
{
...
int MusicEngine::DMusic_Load_MIDI(char *filename)
{
...
int MusicEngine::DMusic_Play(int id)
{
...
int MusicEngine::DMusic_Stop(int id)
{
// stop a midi segment
if (dm_midi[id].dm_segment && dm_midi[id].state!=MIDI_NULL)
   {
...
int MusicEngine::DMusic_Delete_MIDI(int id)
{
...
int MusicEngine::DMusic_Delete_All_MIDI(void)
{
// delete all the MIDI 
int index; // loop var
...
int MusicEngine::DMusic_Status_MIDI(int id)
{
...
int MusicEngine::DMusic_Init(void)
{
...
int MusicEngine::DMusic_Shutdown(void)
{
static int index;
